...
def get_portfolio_value_history(period: str = "1y") -> pd.DataFrame:
...
def _build_twr_components(period: str = "1y"):
...
def get_time_weighted_return(period: str = "1y") -> pd.Series:
    ...
    """
    pv, cf = _build_twr_components(period)
    if pv is None:
...
def get_portfolio_daily_returns(period: str = "1y") -> pd.Series:
